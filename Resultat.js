...
async function AlimentNum(){
    ...
    console.log(tab);
    selectionFinalAliment(tab, myMap, false);
}

function selectionFinalAliment(tab, myMap, test){
    myMap.set("count1", 0);
    myMap.set("count2", 0);
    myMap.set("count3", 0);
    myMap.set("count4", 0);
   ...
   for(var i = 0; i < tab.length; i++){
    ...
    document.getElementById("top1").innerText = "Aliment n°1 : " + tab[myMap.get("indice1")] + " (" + myMap.get("count1") + " votes)" ;
    document.getElementById("top2").innerText = "Aliment n°2 : " + tab[myMap.get("indice2")] + " (" + myMap.get("count2") + " votes)" ;
    document.getElementById("top3").innerText = "Aliment n°3 : " + tab[myMap.get("indice3")] + " (" + myMap.get("count3") + " votes)" ;
   if(test ===  false){
      DessinGraphique();
   }
